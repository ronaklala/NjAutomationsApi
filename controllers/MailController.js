                            ...
                            <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                                <td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
                                    <div class="product-entry">
                                        <img src="${image}" alt="" style="width: auto; max-width: 600px;max-height: 200px;height: auto; margin-bottom: 20px; display: block;">
                                        <div class="text">
                                            <h3>${pname}</h3><br>
  ...
  transporter.sendMail(
    {
      from: "NJ Automations  <sales@njautomation.in>",
      to: email,
      subject: "Update on Your Recent Order From NJ Automations",
      html: `<!DOCTYPE html>
          <html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
          <head>
              <meta charset="utf-8"> <!-- utf-8 works for most cases -->
